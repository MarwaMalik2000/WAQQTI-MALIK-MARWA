...
(function () {
  ...
  var DICT = {
    fr: {
      ...
      'pro.p_nom_salon':'Nom du salon','pro.p_wilaya':'Wilaya','pro.p_telephone':'Téléphone','pro.p_adresse':'Adresse','pro.p_mode':'Mode de réservation','pro.p_mode_creneau':'Par créneau horaire','pro.p_mode_journee':'À la journée (sans horaire)','pro.p_sieges':'Nombre de sièges',
    ...
    ar: {
      ...
      'pro.p_nom_salon':'اسم الصالون','pro.p_wilaya':'الولاية','pro.p_telephone':'الهاتف','pro.p_adresse':'العنوان','pro.p_mode':'نمط الحجز','pro.p_mode_creneau':'حسب الموعد الزمني','pro.p_mode_journee':'باليوم (دون توقيت)','pro.p_sieges':'عدد المقاعد',
