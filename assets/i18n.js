...
(function () {
  ...
  var DICT = {
    fr: {
      ...
      'book.liste_titre':'Complet ou aucun créneau qui vous convient ?','book.liste_sub':'Laissez vos coordonnées : le salon vous prévient dès qu\'une place se libère.','book.liste_tel':'Téléphone','book.liste_email':'E-mail (optionnel)','book.liste_cta':'Me prévenir si une place se libère','book.liste_ok':'Vous êtes sur la liste ! Le salon vous préviendra.','book.liste_nom_requis':'Votre nom est requis.','book.liste_nom_ph':'Ex : Amina K.',
      'book.apropos': 'À propos du salon','book.apropos_vide':'Ce salon n’a pas encore ajouté de description.',
      ...
      'ann.dispo_titre':'Prochaines dispos','ann.dispo_aucune':'Pas de créneau proche','ann.dispo_jour':'Disponible','ann.plus_infos':'Plus d’informations',
    ...
    ar: {
      ...
      'book.liste_titre':'كامل العدد أو لا يوجد موعد مناسب؟','book.liste_sub':'اترك معلوماتك: يخبرك الصالون فور شغور موعد.','book.liste_tel':'الهاتف','book.liste_email':'البريد الإلكتروني (اختياري)','book.liste_cta':'أبلغني إذا شغر موعد','book.liste_ok':'أنت في القائمة! سيخبرك الصالون.','book.liste_nom_requis':'الاسم مطلوب.','book.liste_nom_ph':'مثال: أمينة ك.',
      'book.apropos': 'عن الصالون','book.apropos_vide':'لم يُضِف هذا الصالون وصفاً بعد.',
      ...
      'ann.dispo_titre':'أقرب المواعيد','ann.dispo_aucune':'لا يوجد موعد قريب','ann.dispo_jour':'متاح','ann.plus_infos':'مزيد من المعلومات',
