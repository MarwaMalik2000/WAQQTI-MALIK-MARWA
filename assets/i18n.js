...
(function () {
  ...
  var DICT = {
    fr: {
      ...
      'pro.nouvelle_prestation':'Nouvelle prestation','pro.modifier_prestation':'Modifier prestation','pro.f_categorie':'Catégorie','pro.f_ordre':'Ordre','pro.f_prix':'Prix (DA)','pro.f_duree':'Durée (min)','pro.f_visible':'Visible pour les clients',
    ...
    ar: {
      ...
      'pro.nouvelle_prestation':'خدمة جديدة','pro.modifier_prestation':'تعديل الخدمة','pro.f_categorie':'الفئة','pro.f_ordre':'الترتيب','pro.f_prix':'السعر (دج)','pro.f_duree':'المدة (دقيقة)','pro.f_visible':'مرئية للزبائن',
      ...
      'pro.gal_titre':'📸 معرض الصالون','pro.gal_sub':'تظهر هذه الصور في صفحة حجزك، تحت اسم الصالون.','pro.gal_upsell':'انتقل إلى صيغة « المريحة » (5 صور) أو « المميّزة » (10 صور) لعرض صالونك.','pro.gal_upload':'إضافة صور','pro.gal_plein':'تم بلوغ الحد. احذف صورة لإضافة أخرى.','pro.gal_ok':'تم تحديث المعرض ✓','pro.gal_confirm_del':'حذف هذه الصورة؟','common.supprimer':'حذف',
